...
export default function ProfessionalReferencesForm({
  ...
  const removeReferenceRow = (index) => {
    if (formData.professionalReferences.length > 1) {
      setFormData((prev) => ({
        ...prev,
        professionalReferences: prev.professionalReferences.filter((_, i) => i !== index),
      }));
    }
  };
  ...
  return (
    <div
      className={`max-w-7xl mx-auto ${darkMode ? "bg-gray-900" : "bg-gray-50"}`}
    >
      <div className="text-center mb-8">
        <h1
          className={`text-3xl font-bold ${darkMode ? "text-gray-100" : "text-gray-800"} mb-2`}
      ...
      <div className="space-y-8">
        {/* Professional References Section - Table Format */}
        <Card
          className={`p-6 ${referencesSuccess ? "bg-gradient-to-r from-green-50 to-emerald-50 border-green-200" : "bg-gradient-to-r from-blue-50 to-indigo-50 border-blue-200"} ${darkMode ? "from-gray-800 to-gray-700 border-gray-600" : ""}`}
        >
          <div className="flex items-center justify-between mb-6">
          ...
          {/* Table View for References */}
          <div className="overflow-x-auto mb-6">
            <Table className="w-full">
              <TableHeader>
                <TableRow className={darkMode ? "border-gray-700" : "border-gray-200"}>
                  <TableHead className={`${darkMode ? "text-gray-300" : "text-gray-700"} font-semibold min-w-[150px]`}>Name</TableHead>
                  <TableHead className={`${darkMode ? "text-gray-300" : "text-gray-700"} font-semibold min-w-[130px]`}>Designation</TableHead>
                  <TableHead className={`${darkMode ? "text-gray-300" : "text-gray-700"} font-semibold min-w-[150px]`}>Company</TableHead>
                  <TableHead className={`${darkMode ? "text-gray-300" : "text-gray-700"} font-semibold min-w-[120px]`}>Phone</TableHead>
                  <TableHead className={`${darkMode ? "text-gray-300" : "text-gray-700"} font-semibold min-w-[180px]`}>Email</TableHead>
                  <TableHead className={`${darkMode ? "text-gray-300" : "text-gray-700"} font-semibold min-w-[120px]`}>Known Period</TableHead>
                  <TableHead className={`${darkMode ? "text-gray-300" : "text-gray-700"} font-semibold min-w-[180px]`}>Capacity</TableHead>
                  <TableHead className={`${darkMode ? "text-gray-300" : "text-gray-700"} font-semibold w-[60px]`}></TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                {formData.professionalReferences.map((reference, index) => (
                  <TableRow key={index} className={darkMode ? "border-gray-700" : "border-gray-200"}>
                    <TableCell className="p-1">
                      <Input
                        ...
                        className={`text-sm h-9 ${darkMode ? "bg-gray-700 text-white border-gray-600" : "bg-white text-gray-900"}`}
                      />
                    </TableCell>
                    <TableCell className="p-1">
                      <Input
                    ...
                    <TableCell className="p-1">
                      <Input
                        value={reference.phoneNumber}
                        onChange={(e) =>
                          handleReferenceChange(index, "phoneNumber", e.target.value)
                        }
                        placeholder="Phone"
                        className={`text-sm h-9 ${darkMode ? "bg-gray-700 text-white border-gray-600" : "bg-white text-gray-900"}`}
                        maxLength={10}
                    ...
                    <TableCell className="p-1">
                      <Input
                        value={reference.knownPeriod}
                        onChange={(e) =>
                          handleReferenceChange(index, "knownPeriod", e.target.value)
                        }
          ...
          <div className="flex justify-end mb-4">
            <Button
              ...
              className={`flex items-center gap-2 ${darkMode ? "border-gray-600 text-gray-300 hover:bg-gray-700" : "border-gray-300 text-gray-700 hover:bg-gray-100"}`}
            >
              <Plus size={16} />
              Add Reference
            </Button>
