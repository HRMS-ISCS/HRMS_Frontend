...
// //       <div
// //         className={`sticky top-0 z-40 ${darkMode ? "bg-gray-800/90 border-gray-700" : "bg-white/90 border-gray-100"} backdrop-blur-sm border-b`}
// //       >
...
//       {/* Steps Header - Fixed at top, adjusted for sidebar */}
//       <div
//         className={`fixed top-16 z-30 steps-header-fixed ${darkMode ? "bg-gray-800/90 border-gray-700" : "bg-white/90 border-gray-100"} backdrop-blur-sm border-b`}
//         style={{ 
//           top: '64px',
//           left: 0,
//           right: 0,
