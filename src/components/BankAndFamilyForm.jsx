  ...
  return (
    <div className={`max-w-5xl mx-auto ${darkMode ? 'bg-gray-900' : 'bg-gray-50'}`}>
      ...
      <div className="space-y-8">
        ...
        <Card className={`p-6 ${maritalSuccess && familySuccess ? 'bg-gradient-to-r from-green-50 to-emerald-50 border-green-200' : 'bg-gradient-to-r from-blue-50 to-rose-30 border-pink-200'} ${darkMode ? 'from-gray-800 to-gray-700 border-gray-600' : ''}`}>
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-2">
              ...
              <tbody>
                {familyMemberTypes.map(({ key, label }) => {
                  ...
                  return (
                    <tr 
                      key={key} 
                      className={`${darkMode ? 'hover:bg-gray-700' : 'hover:bg-gray-50'} ${isDisabled ? 'opacity-50' : ''}`}
                    >
                      <td className={`border ${darkMode ? 'border-gray-600' : 'border-gray-300'} px-2 py-2`}>
                        <div className="flex items-center gap-2">
                          ...
                          <Input
                            ...
                            disabled={isDisabled}
                            className={`text-sm ${darkMode ? 'bg-gray-700 text-white border-gray-600' : 'bg-white text-gray-900'} ${isDisabled ? 'cursor-not-allowed' : ''}`}
                          />
                        </div>
                      </td>
                      <td className={`border ${darkMode ? 'border-gray-600' : 'border-gray-300'} px-2 py-2`}>
