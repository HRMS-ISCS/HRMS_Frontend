...
// //         `http://127.0.0.1:8000/db/generate-sas/${employeeId}`
// //       );
...
// //         setFetchedEmployeeId(employeeId);
        
// //         // Check if any documents were found
// //         const hasAnyDoc = Object.values(newDocs).some(doc => doc && doc.sas_url);
// //         if (!hasAnyDoc) {
// //           setError("No documents found for this Employee ID");
// //         }
// //       } else {
// //         setError("Failed to fetch documents. Please check the Employee ID and try again.");
// //       }
// //     } catch (err) {
...
// //           <h2 className="text-xl font-semibold text-gray-800">Search Documents</h2>
// //         </div>
...
// //                 placeholder="Enter Employee ID (e.g., ISCSI001 or ISCSE001)"
...
// //               disabled={loading}
// //               className="px-6 bg-blue-200 text-blue-800 hover:bg-blue-300"
// //             >
// //               {loading ? (
// //                 <>
...
// //               Documents for Employee: <span className="text-blue-600">{fetchedEmployeeId}</span>
// //             </h3>
// //           </div>
...
// //                 <Card
// //                   key={config.type}
// //                   className={`p-6 bg-gradient-to-r ${config.color} ${config.borderColor} transition-all hover:shadow-lg`}
// //                 >
...
// //       {selectedDoc && (
// //         <Card id="document-preview" className="p-6 bg-white border-gray-200 mb-8">
...
// //       {/* Company Info Footer */}
// //       <Card className="mt-8 bg-gradient-to-r from-gray-50 to-slate-50 border-gray-200 p-6">
// //         <div className="text-center">
...
//           <h2 className="text-xl font-semibold text-gray-800">Select Employee</h2>
//         </div>
        
//         <div className="space-y-4">
//           <div className="grid grid-cols-1 md:grid-cols-1 gap-4">
//             <div className="space-y-2">
//               <Label className="text-gray-700 font-medium">Search Employee *</Label>
...
//                 />
//                 <ChevronDown 
//                   className={`absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 transition-transform ${dropdownOpen ? 'rotate-180' : ''}`}
//                   size={20}
//                 />
//               </div>
