...
export default function Documents() {
    ...
    const [documents, setDocuments] = useState({
        ...
        inter_certificate: null,
        grad_certificate: null,
        postgrad_certificate: null,
        diploma_certificate: null,
        other_certificate: null,
        
        // Experience Documents (excluding form_16)
    ...
    const educationCertificateConfig = [
        {
            type: "ssc_certificate",
            label: "SSC / 10th Certificate",
            icon: GraduationCap,
            color: "from-amber-50 to-yellow-50",
            iconColor: "text-amber-600",
            borderColor: "border-amber-200",
            ...
            darkIconColor: "text-amber-400",
            darkBorderColor: "border-amber-700",
            certificateName: "SSC / 10th"
        },
        {
            type: "inter_certificate",
            ...
            darkIconColor: "text-orange-400",
            darkBorderColor: "border-orange-700",
            certificateName: "Intermediate / 12th"
        },
        {
            type: "grad_certificate",
        ...
        },
        {
            ...
            darkIconColor: "text-blue-400",
            darkBorderColor: "border-blue-700",
            certificateName: "Post Graduation"
        },
        {
        ...
        },
        {
            ...
            darkColor: "from-gray-900/30 to-slate-900/30",
            darkIconColor: "text-gray-400",
            darkBorderColor: "border-gray-700",
            certificateName: "Other"
        }
    ];

    const experienceDocumentConfig = [
        {
            ...
            darkColor: "from-cyan-900/30 to-teal-900/30",
        ...
        },
        {
            ...
            darkBorderColor: "border-rose-700",
    ...
    const fetchEmployeeDocuments = async (employeeId) => {
        ...
        try {
            ...
            const newDocs = {
                ...
                // Education Certificates
                ssc_certificate: data.education_certificates?.ssc_certificate || null,
                inter_certificate: data.education_certificates?.inter_certificate || null,
                grad_certificate: data.education_certificates?.grad_certificate || null,
                postgrad_certificate: data.education_certificates?.postgrad_certificate || null,
                diploma_certificate: data.education_certificates?.diploma_certificate || null,
                other_certificate: data.education_certificates?.other_certificate || null,
                
                // Experience Documents (excluding form_16)
                experience_letter: data.experience_documents?.experience_letter || null,
                relieving_letter: data.experience_documents?.relieving_letter || null,
                last_payslip: data.experience_documents?.last_payslip || null,
                offer_letter: data.experience_documents?.offer_letter || null
                // form_16 is intentionally excluded
            };
    ...
    const handleClear = () => {
        ...
        setDocuments({
            ...
            signed_diversity_policy: null, signed_employee_handbook: null,
            signed_info_security_policy: null, signed_operational_risk_policy: null,
            ssc_certificate: null, inter_certificate: null, grad_certificate: null,
            postgrad_certificate: null, diploma_certificate: null, other_certificate: null,
            experience_letter: null, relieving_letter: null, last_payslip: null, offer_letter: null
        });
        setHasUnsignedNDA(false);
        setHasUnsignedJoiningLetter(false);
        setSelectedFiles({ nda: null, joining_letter: null });
        ...
        <div className={`w-full min-h-screen p-3 sm:p-4 md:p-6 ${darkMode ? 'bg-gray-900' : 'bg-gray-50'}`}>
            ...
            {fetchedEmployeeId && !error && (
                <>
                    ...
                    <div className="mb-6 sm:mb-8">
                        <div className="flex items-center gap-2 mb-3 sm:mb-4">
                            <GraduationCap className={darkMode ? "text-amber-400" : "text-amber-600"} size={16} />
                            <h4 className={`text-base sm:text-lg font-semibold ${darkMode ? 'text-gray-100' : 'text-gray-800'}`}>Education Certificates</h4>
                        </div>
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 md:gap-5">
                            {educationCertificateConfig.map((config) => {
                                const doc = documents[config.type];
                                const Icon = config.icon;
                                const isAvailable = doc && doc.sas_url;
                    ...
                    <div className="mb-6 sm:mb-8">
                        <div className="flex items-center gap-2 mb-3 sm:mb-4">
                            <Briefcase className={darkMode ? "text-cyan-400" : "text-cyan-600"} size={16} />
                            <h4 className={`text-base sm:text-lg font-semibold ${darkMode ? 'text-gray-100' : 'text-gray-800'}`}>Experience Documents</h4>
                        </div>
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-3 sm:gap-4 md:gap-5">
                            {experienceDocumentConfig.map((config) => {
                                const doc = documents[config.type];
                                const Icon = config.icon;
                                const isAvailable = doc && doc.sas_url;
