...
//   const [tableItemsPerPage] = useState(5); // 5 rows per page
...
//   const sectionColors = {
//     personalProfile: { bg: "bg-blue-50", border: "border-blue-200", iconBg: "bg-blue-100", iconColor: "text-blue-600", headerBg: "hover:bg-blue-50", badgeBg: "bg-blue-100", badgeText: "text-blue-700" },
//     bankAccount: { bg: "bg-green-50", border: "border-green-200", iconBg: "bg-green-100", iconColor: "text-green-600", headerBg: "hover:bg-green-50", badgeBg: "bg-green-100", badgeText: "text-green-700" },
//     maritalStatus: { bg: "bg-pink-50", border: "border-pink-200", iconBg: "bg-pink-100", iconColor: "text-pink-600", headerBg: "hover:bg-pink-50", badgeBg: "bg-pink-100", badgeText: "text-pink-700" },
//     familyBackground: { bg: "bg-purple-50", border: "border-purple-200", iconBg: "bg-purple-100", iconColor: "text-purple-600", headerBg: "hover:bg-purple-50", badgeBg: "bg-purple-100", badgeText: "text-purple-700" },
//     academicBackground: { bg: "bg-indigo-50", border: "border-indigo-200", iconBg: "bg-indigo-100", iconColor: "text-indigo-600", headerBg: "hover:bg-indigo-50", badgeBg: "bg-indigo-100", badgeText: "text-indigo-700" },
//     professionalTraining: { bg: "bg-teal-50", border: "border-teal-200", iconBg: "bg-teal-100", iconColor: "text-teal-600", headerBg: "hover:bg-teal-50", badgeBg: "bg-teal-100", badgeText: "text-teal-700" },
//     professionalExperience: { bg: "bg-orange-50", border: "border-orange-200", iconBg: "bg-orange-100", iconColor: "text-orange-600", headerBg: "hover:bg-orange-50", badgeBg: "bg-orange-100", badgeText: "text-orange-700" },
//     professionalReference: { bg: "bg-cyan-50", border: "border-cyan-200", iconBg: "bg-cyan-100", iconColor: "text-cyan-600", headerBg: "hover:bg-cyan-50", badgeBg: "bg-cyan-100", badgeText: "text-cyan-700" },
//     aboutSelf: { bg: "bg-amber-50", border: "border-amber-200", iconBg: "bg-amber-100", iconColor: "text-amber-600", headerBg: "hover:bg-amber-50", badgeBg: "bg-amber-100", badgeText: "text-amber-700" },
//     declaration: { bg: "bg-slate-50", border: "border-slate-200", iconBg: "bg-slate-100", iconColor: "text-slate-600", headerBg: "hover:bg-slate-50", badgeBg: "bg-slate-100", badgeText: "text-slate-700" },
//   };
...
//         <div className="text-sm text-gray-800 break-words bg-white px-2 py-1 rounded border border-gray-100">{value || "N/A"}</div>
//       </div>
//     </div>
//   );
...
//               ) : (
//                 <div className="w-20 h-20 bg-gray-100 rounded-full flex items-center justify-center border-2 border-white shadow-md">
...
//                   </td>
//                   <td className="px-3 py-2">
//                     <Button variant="ghost" size="sm" className="h-6 px-2 text-xs" onClick={() => searchEmployeeById(employee.employee_id)}>
...
//       {!searchMode && allEmployees.length > tableItemsPerPage && (
...
//           </div>
//           <div className="flex items-center gap-1">
//             <Button variant="outline" size="sm" className="h-8 w-8 p-0" onClick={() => setCurrentPage(prev => Math.max(prev - 1, 1))} disabled={currentPage === 1}>
//               <ChevronLeft size={14} />
//             </Button>
...
//               );
//             })}
//             <Button variant="outline" size="sm" className="h-8 w-8 p-0" onClick={() => setCurrentPage(prev => Math.min(prev + 1, totalPages))} disabled={currentPage === totalPages}>
...
//               <Input type="text" value={searchEmployeeId} onChange={(e) => setSearchEmployeeId(e.target.value)} onKeyPress={handleKeyPress} placeholder="Search by Employee ID" className="pl-8 h-8 w-48 text-sm" />
//             </div>
//             <Button onClick={() => searchEmployeeById()} disabled={searchLoading} size="sm" className="h-8 px-3">
...
//                 <Button variant={viewMode === "cards" ? "default" : "ghost"} size="sm" className="h-6 px-2" onClick={() => setViewMode("cards")}>
//                   <Grid size={14} />
//                 </Button>
//                 <Button variant={viewMode === "table" ? "default" : "ghost"} size="sm" className="h-6 px-2" onClick={() => setViewMode("table")}>
//                   <List size={14} />
//                 </Button>
//               </div>
//             )}
...
//             </span>
//           </div>
//           {!searchMode && <div className="text-xs text-gray-500">Last updated: {new Date().toLocaleTimeString()}</div>}
//         </div>
...
export default function Employees() {
  ...
  const EmployeeCard = ({ employee }) => {
    ...
    return (
      <Card className={`group hover:shadow-lg transition-all duration-300 overflow-hidden relative ${darkMode ? 'bg-gray-800 border-gray-700' : 'bg-gradient-to-b from-blue-50 to-white border-gray-200'}`}>
        <div className="relative p-4">
          <div className="flex flex-col items-center mb-4">
            <div className="relative">
          ...
          <div className="flex items-center justify-between pt-3 border-t border-gray-100">
            <div className="flex items-center gap-1">
              ...
              <div>
                ...
                <p className={`text-[10px] ${darkMode ? 'text-gray-200' : 'text-gray-700'} font-medium`}>
                  {formatDate(employee.date_of_joining || personalProfile.date_of_joining)}
                </p>
              </div>
            </div>
  ...
  return (
    <div className={`p-4 space-y-4 max-w-full ${darkMode ? 'bg-gray-900' : 'bg-gray-50'}`}>
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-3">
        <div>
