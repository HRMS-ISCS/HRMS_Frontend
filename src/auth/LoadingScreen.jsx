...
//               <span className="text-6xl font-light italic text-transparent bg-clip-text bg-gradient-to-r from-purple-600 via-pink-500 to-blue-500 drop-shadow-lg" style={{ fontFamily: 'Brush Script MT, cursive' }}>
//                 Hi,
//               </span>
//               <span className="text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-indigo-500 to-purple-500 drop-shadow-lg tracking-wide">
//                 {displayedName}!
//               </span>
//             </div>
//           )} */}
    ...
    <div className={`min-h-screen bg-white flex items-center justify-center relative overflow-hidden transition-opacity duration-500 ${isFadingOut ? 'opacity-0' : 'opacity-100'}`}>
      ...
      <div className={`relative z-10 flex flex-col items-center space-y-12 transition-all duration-500 ${isFadingOut ? 'scale-95' : 'scale-100'}`}>
        ...
        <div className="text-center space-y-6">
          ...
          {/* ISCS Technologies Information */}
          {!loading && (
            <div className="max-w-2xl mx-auto mt-6 animate-fade-in-delayed">
              <h2 className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-500 mb-3">
                ISCS Technologies
              </h2>
              <h3 className="text-xl text-gray-600 mb-4">Innovative Strategic Consulting Services</h3>
              <p className="text-gray-700 mb-4">
                We provide end-to-end IT solutions focused on digital transformation, leveraging AI, cloud computing, and data analysis.
              </p>
              <p className="text-gray-700 mb-4">
                Our global consulting team helps bridge technological innovation with business success through enterprise integration and customized digital solutions.
              </p>
              <div className="flex flex-wrap justify-center gap-3 mt-4">
                <span className="px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-sm">Digital Transformation</span>
                <span className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm">AI Solutions</span>
                <span className="px-3 py-1 bg-green-100 text-green-700 rounded-full text-sm">Cloud Computing</span>
                <span className="px-3 py-1 bg-indigo-100 text-indigo-700 rounded-full text-sm">Data Analysis</span>
              </div>
            </div>
          )}
